...
public class VentanaSeleccionarEstadoReclamo extends javax.swing.JFrame {
    ...
    public VentanaSeleccionarEstadoReclamo(BigInteger idUser, Reclamo reclamos, VentanaInternaReclamos ventanaInternaRec) {
    ...
    private void btnEnviarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEnviarMouseClicked
        ...
        if (cmbEstado.getSelectedItem().equals(reclamos.getIdEstadoPeticion().getNomEstado())) {
            ...
            try {
                ...
                seModifico = recBean.modificarEstado(reclamos, estado, date);
                this.reclamos.setIdEstadoPeticion(estado);
                this.reclamos.setFechaHora(date);
            } catch (Exception ex) {
            ...
            if (seModifico) {
                ...
                clearObject(recBean.buscarReclamoPorId(reclamos.getIdReclamo()));  
            } else {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        cmbEstado.setSelectedItem(reclamos.getIdEstadoPeticion().getNomEstado());
