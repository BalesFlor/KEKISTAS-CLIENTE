...
public class VentanaAnalista extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VentanaAnalista
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAnalista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAnalista().setVisible(true);
            }
        });
    }
