...
public class RegistroEstudiante extends JFrame {
	...
	public RegistroEstudiante() {
		...
		JLabel lblRegistroEstudiante = new JLabel("REGISTRO ESTUDIANTE");
		...
		JLabel lblAñoIngreso = new JLabel("Año de ingreso:");
		lblAñoIngreso.setFont(new Font("Arial", Font.PLAIN, 16));
		lblAñoIngreso.setBounds(27, 416, 149, 17);
		contentPane.add(lblAñoIngreso);
		...
		JComboBox comboBoxAñoIngreso = new JComboBox();
		comboBoxAñoIngreso.setBounds(184, 416, 151, 23);
		contentPane.add(comboBoxAñoIngreso);
		
		JButton btnRegistrarse = new JButton("REGISTRARSE");
		btnRegistrarse.setFont(new Font("SquareFont", Font.PLAIN, 15));
		btnRegistrarse.setBounds(75, 471, 215, 40);
		...
		btAtras.setBounds(290, 512, 77, 19);
