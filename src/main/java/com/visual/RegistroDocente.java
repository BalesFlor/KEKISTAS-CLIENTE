...
public class RegistroDocente extends JFrame {
	...
	public RegistroDocente() {
		...
		JLabel lblRegistroEstudiante = new JLabel("REGISTRO DOCENTE");
		...
		btnAtras.setBounds(290, 540, 77, 19);
